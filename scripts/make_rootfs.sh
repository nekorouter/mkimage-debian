...
make_rootfs()
{
    ...
    mmdebstrap --architectures=riscv64 --include="debian-ports-archive-keyring locales" sid "$CHROOT_TARGET" "deb http://ftp.ports.debian.org/debian-ports/ sid main contrib non-free"
